        ...
        <div class="col-12 text-md-start">
            <div class="row text-sm-center text-md-start">
                ...
                <div class="col-12 col-md-4 col-lg-3 mx-auto mt-3">
                    ...
                    <p><i class="bi bi-house-fill"></i> Colombo Kandy Rode,<br>Keglle Sri Lanka</p>
                    <p><i class="bi bi-at"></i> itcare@yahoo.com</p>
                    <p><i class="bi bi-telephone-fill"></i> +94 357 914 150</p>
